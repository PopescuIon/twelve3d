...
const Models = () => {
  ...
  const models = [
    { id: 1, name: 'Model Numbers', image: modelNumbers, price80: 799, price100: 899 },
    { id: 2, name: 'Model RetroTech', image: modelRetrotech, price80: 699, price100: 799 },
    { id: 3, name: 'Model Roman', image: modelRoman, price80: 799, price100: 899 },
    { id: 4, name: 'Model Minimalist', image: modelMinimalist, price80: 699, price100: 799 },
    { id: 5, name: 'Model Coffe', image: modelCoffe, price80: 799, price100: 899 },
    { id: 6, name: 'Model Creative', image: modelCreative, price80: 699, price100: 799 },
    { id: 7, name: 'Model Music', image: modelMusic, price80: 799, price100: 899 },
    { id: 8, name: 'Ceas pe Oglindă', image: modelOglinda, price60: 1949 },
    { id: 9, name: 'Home + Ceas', image: modelHomeclock, width150: 1850 },
    { id: 10, name: 'Home Sweet Home', image: modelHomesweet, length200: 2500 },
  ];
        ...
        <section id="contact" className="mt-24 py-12 px-4 md:px-8 rounded-2xl fade-in">
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                <h2 className="text-3xl font-bold mb-6">{t('modelsContactTitle')}</h2>
                <div className="space-y-4">
                  <a href="mailto:twelve.clock@yahoo.com" className="flex items-center gap-3 text-muted-foreground hover:text-primary transition-colors">
                    <Mail className="h-5 w-5" />
                    <span>twelve.clock@yahoo.com</span>
                  </a>
                  <a href="tel:+37360592006" className="flex items-center gap-3 text-muted-foreground hover:text-primary transition-colors">
              ...
              <div 
                className="relative rounded-2xl p-8 backdrop-blur-sm bg-background/85"
                style={{
